...
EXTRA = [
    "*.png",  # matplotlib plots (production schedules, inventory profiles, cost breakdowns)
    "*.lp",   # Pyomo exported LP model files
    "*.nl",   # Pyomo exported NL (nonlinear) model files
    "*.sol",  # Solver solution files
