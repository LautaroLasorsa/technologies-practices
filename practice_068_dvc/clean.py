...
EXTRA = [
    "tmp_remote_storage",   # DVC local remote (simulated cloud storage)
    "data",                 # All data dirs (raw CSVs, prepared splits)
    "models",               # Trained model artifacts
    "metrics",              # Evaluation metrics JSON files
    "dvc.yaml",             # Pipeline definition (recreated in exercises)
    "dvc.lock",             # Pipeline lockfile (auto-generated by dvc repro)
