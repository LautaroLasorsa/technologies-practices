...
EXTRA = [
    "spark-warehouse/",    # Spark metastore warehouse directory
    "output/",             # Spark job output directory
    "derby.log",           # Derby metastore log
    "metastore_db/",       # Derby metastore database
]
