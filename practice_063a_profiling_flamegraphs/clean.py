...
EXTRA = [
    "*.svg",           # flamegraph SVG outputs (flamegraph.svg, before.svg, after.svg, etc.)
    "perf.data",       # Linux perf sampling data
    "perf.data.old",   # previous perf.data backup
    "dhat-heap.json",  # DHAT heap profiling output
]
