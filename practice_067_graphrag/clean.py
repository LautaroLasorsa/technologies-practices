...
EXTRA = [
    "output",          # GraphRAG indexing output (Parquet files: entities, relationships, communities, etc.)
    "lancedb",         # LanceDB vector store data generated during indexing
    "settings.yaml",   # GraphRAG config generated by `graphrag init`
    ".env",            # Environment file generated by `graphrag init`
]
