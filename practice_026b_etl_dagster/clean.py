...
EXTRA = [
    ".dagster/",               # Dagster local instance storage
    "storage/",                # Dagster run storage directory
    "dbt_project/target/",     # dbt compiled SQL and run artifacts
    "dbt_project/dbt_packages/",  # dbt installed packages
