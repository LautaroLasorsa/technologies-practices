...
EXTRA = [
    "app/spark-warehouse/",   # Spark metastore warehouse directory
    "app/output/",            # Pipeline output (parquet files, etc.)
    "app/derby.log",          # Derby metastore log
    "app/metastore_db/",      # Derby metastore database
]
