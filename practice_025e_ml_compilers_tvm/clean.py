...
EXTRA = [
    "**/*.tar",              # TVM compiled model archives
    "**/*.so",               # TVM compiled shared libraries
    "**/*tuning*.log",       # Ansor/AutoTVM tuning log files
    "**/*autoscheduler*.json",  # Ansor auto-scheduler task records
]
